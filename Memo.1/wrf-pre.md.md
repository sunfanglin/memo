...
- Sometimes it occurs at the first 10 min, when wrf start to store variables, the reason is that the domains have too much grids. The largest nest feasible is 262$$265

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNjg1OTg1NTldfQ==
-->