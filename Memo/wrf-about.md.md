...
> “gwd_opt=3”
## SMS-3DTKE 
is a scale-aware PBL scheme, which is especially useful for nest cases with large differences in grid size between domains. You are right that to implement this scheme, you need to set bl_pbl_physics = 0, diff_opt = 2, and km_opt = 5.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwODk2NzA5NF19
-->